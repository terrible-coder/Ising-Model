 ...
 * 
 * @param c 
 * @param i Position of the spin to be flip.
 * @return float 
 */
float flipChange(Ising& c, pos& i);
/**
 * @brief Calculates the change in energy (in units of J) for flipping of
 * single spin.
 * 
 ...
 * 
 * @param c 
 * @param i Position of spin 1.
 * @param j Position of spin 2.
 * @return float 
 */
float exchangeChange(Ising& c, pos const& i, pos const& j);
/**
 * @brief Calculates the change in energy (in units of J) for exchanging two
 * neighbouring spins.
 * 
 ...
 * @return float 
 */
float exchangeChange(Ising& c, vec3<int> const& i, vec3<int> const& j);

// This will be removed soon if not needed.
// class ExchangeList {
// private:
